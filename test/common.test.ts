...
test("common.string", () => {
    ...
    expect(common.string.isRangeText("")).toBeFalsy()
    expect(common.string.isRangeText(" ")).toBeFalsy()
    expect(common.string.isRangeText(",")).toBeFalsy()
    expect(common.string.isRangeText(":")).toBeFalsy()
    expect(common.string.isRangeText("1")).toBeTruthy()
    expect(common.string.isRangeText("2")).toBeTruthy()
    expect(common.string.isRangeText("2:5")).toBeTruthy()
    expect(common.string.isRangeText("-1")).toBeTruthy()
    expect(common.string.isRangeText("-2")).toBeTruthy()
    expect(common.string.isRangeText("-5:-2")).toBeTruthy()
    expect(common.string.isRangeText("2,4:7,-5:-2")).toBeTruthy()
    expect(common.string.isRangeText("  2  , 4  : 7 , -5  : -2  ")).toBeTruthy()
    expect(common.string.isRangeText("1,")).toBeTruthy()
    expect(common.string.isRangeText("1:")).toBeFalsy()
    expect(common.string.isRangeText("1::5")).toBeFalsy()
    expect(common.string.isRangeText("1,,2")).toBeFalsy()
    expect(common.string.isRangeText("1，2，3：4,9")).toBeTruthy()
})
