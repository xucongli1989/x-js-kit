...
test("common.color", () => {
    ...
    expect(common.color.rgbaToHex(1, 2, 3)).toBe("#010203")
    expect(common.color.rgbaToHex(12, 34, 56)).toBe("#0c2238")
    expect(common.color.rgbaToHex(12, 34, 56, 0)).toBe("#0c223800")
    expect(common.color.rgbaToHex(12, 34, 56, 255)).toBe("#0c2238ff")
})