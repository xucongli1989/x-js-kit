 ...
 */
export declare function appendElementToLimitContainer(containerElement: HTMLElement, subElement: HTMLElement, maxCount: number, ellipsisElement: HTMLElement): AppendElementToLimitContainerResultType;
